...
import colorVariables from "../constants/color-variables";
...
function Home() {
  ...
  const scrollToView = () => {
    document.getElementsByClassName('Home-header-form')[0].scrollIntoView({ behavior: "smooth"})
  }
    ...
    <div className="Home">
      <header className="Home-header">
        <section>
          ...
          <p className="Home-title">{theme}</p>
          <p className="Home-button-group"><button onClick={toggleColor()}>切换显示</button></p>
          ...
          <div className="Home-header-bottom" onClick={scrollToView}>
            <div className="Home-header-bottom-icon">
              <div></div>
              <div></div>
            </div>
            &nbsp;滚动获取更多
      ...
      <section style={{flex: 1, overflow: 'auto', padding: '12px 0', display: showColor ? 'block' : 'none'}}>
        {
          colorVariables.map((variable, index) => (
            <div className="Home-content-color" key={index}>
              <div className="Home-content-color-content">
                <div className="Home-content-color-name">
                  {variable.name}
                </div>
                <div className="Home-content-color-note">
                  {variable.property}
                </div>
              </div>
              <div className="Home-content-color-palette" style={{ background: `var(${variable.property})` }}></div>
              <div className="Home-content-color-value">
                {variable.value}
              </div>
            </div>
          ))
